...
export type GetSessionProfileResponse = z.infer<
  typeof getSessionProfileResponseSchema
>;
...
export const exportSessionRequestSchema = z
  .object({
    web_log: z
      .string()
      .refine(
        (value) => fitsUtf8ByteLimit(value, MAX_SESSION_EXPORT_WEB_LOG_BYTES),
        {
...
export type UpdateSessionProfileResponse = z.infer<
  typeof updateSessionProfileResponseSchema
>;
...
export const updateSessionMetaResponseSchema =
  updateSessionProfileResponseSchema;
...
export type StartBtwSessionResponse = z.infer<
  typeof startBtwSessionResponseSchema
>;
...
export const listSessionChildrenResponseSchema =
  pageResponseSchema(sessionSchema);
export type ListSessionChildrenResponse = z.infer<
  typeof listSessionChildrenResponseSchema
>;

export const createSessionChildRequestSchema = sessionChildCreateSchema;
export type CreateSessionChildRequest = z.infer<
  typeof createSessionChildRequestSchema
>;

export const createSessionChildResponseSchema = sessionSchema;
export type CreateSessionChildResponse = z.infer<
  typeof createSessionChildResponseSchema
>;
...
export type GetSessionGoalResponse = z.infer<
  typeof getSessionGoalResponseSchema
>;
...
export type ArchiveSessionResponse = z.infer<
  typeof archiveSessionResponseSchema
>;

export const restoreSessionResponseSchema = sessionSchema;
export type RestoreSessionResponse = z.infer<
  typeof restoreSessionResponseSchema
>;
