...
export type ModelCatalogItem = Awaited<
...
export function createGlobalFacade(
  ...
  const call: Caller = (service, method, args) =>
    scoped({}, service, method, args);
  ...
  const env = (): Promise<KlientEnvInfo> => {
    envPromise ??= Promise.all([
      ...
      call("bootstrapService", "clientIdentity", []) as Promise<{
        version: string;
      }>,
    ]).then((values) => {
  ...
  return {
    sessions: {
      list: (query) =>
        call("sessionIndex", "listRecent", [query]) as Promise<
          Page<SessionSummary>
        >,
      get: (id) =>
        call("sessionIndex", "get", [id]) as Promise<
    ...
    workspaces: {
      list: () =>
        call("workspaceService", "list", []) as Promise<readonly Workspace[]>,
      get: (id) =>
        call("workspaceService", "get", [id]) as Promise<Workspace | undefined>,
      createOrTouch: ({ root, name }) =>
        call("workspaceService", "createOrTouch", [
          root,
          name,
    ...
    config: {
      get: <T>(domain: string) =>
        call("configService", "get", [domain]) as Promise<T>,
      getAll: () =>
        call("configService", "getAll", []) as Promise<Record<string, unknown>>,
      inspect: <T>(domain: string) =>
        call("configService", "inspect", [domain]) as Promise<
          ConfigInspectValue<T>
        >,
    ...
    kosong: {
      listProviders: () =>
        ...
        >,
      getProvider: (id) =>
        call("modelResolver", "getProvider", [
          id,
        ]) as Promise<ProviderCatalogItem>,
      addProvider: ((
        ...
        if (typeof idOrConfig === "string") {
          ...
          return call("providerService", "set", [
            idOrConfig,
            wire,
          ]) as Promise<void>;
        }
      ...
      listModels: () =>
        call("modelResolver", "listModels", []) as Promise<
    ...
    auth: {
      ...
      summarize: () =>
        call("authSummaryService", "summarize", []) as Promise<
          readonly AuthStatus[]
        >,
      ensureReady: (modelOverride) =>
        call("authSummaryService", "ensureReady", [
          modelOverride,
        ]) as Promise<void>,
      startLogin: (provider) =>
      ...
      logout: (provider) =>
        call("oauthService", "logout", [
          provider,
        ]) as Promise<OAuthLogoutResponse>,
    ...
    plugins: {
      list: () =>
        call("pluginService", "listPlugins", []) as Promise<
          readonly PluginSummary[]
        >,
      info: (id) =>
        call("pluginService", "getPluginInfo", [{ id }]) as Promise<PluginInfo>,
      install: (source) =>
        call("pluginService", "installPlugin", [
          { source },
        ]) as Promise<PluginSummary>,
      setEnabled: (input) =>
        call("pluginService", "setPluginEnabled", [input]) as Promise<void>,
      setMcpServerEnabled: (input) =>
        call("pluginService", "setPluginMcpServerEnabled", [
          input,
        ]) as Promise<void>,
      remove: (id) =>
        call("pluginService", "removePlugin", [{ id }]) as Promise<void>,
      reload: () =>
    ...
    capabilities: {
      list: () =>
        ...
        >,
      get: (id) =>
        call("capabilityService", "getCapability", [
          id,
    ...
    hostFs: {
      browse: (absPath) =>
        call("hostFolderBrowser", "browse", [
          absPath,
        ]) as Promise<FsBrowseResponse>,
      home: () =>
        call("hostFolderBrowser", "home", []) as Promise<FsHomeResponse>,
    },
