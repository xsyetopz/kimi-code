...
export const KNOWN_DIFFERENCES: readonly KnownDifference[] = [
  ...
  },
  {
    ...
    summary:
      "Trailing && / | yields a single-child list/pipeline with hasError.",
  },
  {
    id: "empty-backtick",
  ...
  },
  {
    ...
    summary:
      '$((0x1F)) → number "0x1F"; the reference produces variable_name (a quirk).',
  },
  {
    id: "test-paren-group-logical",
    readmeAnchor: "`[[ ((a) == x) && y ]]`",
    summary:
      "Parenthesized test group followed by && parses cleanly; the reference mis-reads it.",
  },
  {
  ...
  },
  {
    ...
    summary:
      'This parser produces extglob_pattern "-0.5"; the reference a unary_expression.',
  },
  {
    id: "test-fused-operator-expansion",
    readmeAnchor: "A test operator fused with an expansion (`[[ -x$f && … ]]`)",
    summary:
      "Flat concatenation of -x and $f here; the reference wraps a unary_expression.",
  },
  {
    id: "test-escaped-pipe-pattern",
    readmeAnchor: "An escaped `|` inside a pattern (`[[ $a == foo\\|bar ]]`)",
    summary:
      'One extglob_pattern "foo\\|bar" here; the reference splits the expression.',
  },
  {
  ...
  },
  {
    ...
    summary:
      "Multiline strings keep one string_content; the reference splits it.",
  },
  {
  ...
  },
  {
    ...
    readmeAnchor: "`${=1}`",
    summary:
      "The zsh-style ${=…} form: the reference produces variable_name; this parser a word.",
  },
  {
  ...
  },
  {
    ...
    summary:
      "The reference drops the first backslash (a quirk); this parser keeps both.",
  },
];
