...
import {
  ...
  type TextChunk,
  wordWrapLine,
} from "./editor/word-wrap.ts";
export type { TextChunk } from "./editor/word-wrap.ts";
export { wordWrapLine } from "./editor/word-wrap.ts";
...
export class Editor implements Component, Focusable {
  ...
  private autocompleteTriggerPattern = buildTriggerPattern(
    this.autocompleteTriggerCharacters,
  );
  private autocompleteDebouncePattern = buildDebouncePattern(
    this.autocompleteTriggerCharacters,
  );
