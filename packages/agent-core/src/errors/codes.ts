...
export const KIMI_ERROR_INFO = {
  ...
  "session.state_invalid": {
    ...
    public: true,
    action:
      "The session state.json is corrupted; remove the session or repair the file.",
  },
  ...
  "goal.status_invalid": {
    ...
    public: true,
    action:
      "Use a status allowed for this actor (complete, blocked, or impossible).",
  },
  ...
  "provider.api_error": {
    ...
    public: true,
    action:
      "Inspect details.statusCode / details.requestId; check provider status.",
  },
  "provider.filtered": {
  ...
  "mcp.startup_failed": {
    ...
    public: true,
    action:
      "Inspect the MCP server log or call reconnect once the server is healthy.",
  },
  "mcp.tool_name_collision": {
    ...
    public: true,
    action:
      "Rename one of the colliding MCP tools or servers so their qualified names are unique.",
  },
  ...
  "plugin.load_failed": {
    ...
    public: true,
    action:
      "Fix the installed.json file under $KIMI_CODE_HOME/plugins/ and run /plugins reload.",
  },
