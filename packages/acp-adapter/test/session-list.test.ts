...
class StubClient implements Client {
  async requestPermission(
    ...
    throw new Error(
      "StubClient.requestPermission should not be called in session-list test",
    );
  }
  async sessionUpdate(_n: SessionNotification): Promise<void> {
    throw new Error(
      "StubClient.sessionUpdate should not be called in session-list test",
    );
  }
  async writeTextFile(
    ...
    throw new Error(
      "StubClient.writeTextFile should not be called in session-list test",
    );
  }
  async readTextFile(_p: ReadTextFileRequest): Promise<ReadTextFileResponse> {
    throw new Error(
      "StubClient.readTextFile should not be called in session-list test",
    );
  }
}
