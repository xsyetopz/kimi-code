...
export interface TelemetryEventDefinition<
  P,
  C extends TelemetryEventContext = "none",
> {
  readonly context: C;
...
export function defineTelemetryEvent<P>(
  meta: TelemetryEventMeta & {
    readonly properties: { [K in keyof P]-?: string };
  },
...
export const telemetryEventDefinitions = {
  ...
  permission_policy_decision:
    defineAgentTelemetryEvent<PermissionPolicyDecisionEvent>({
      owner: "kimi-code",
  ...
  permission_approval_result:
    defineAgentTelemetryEvent<PermissionApprovalResultEvent>({
      owner: "kimi-code",
  ...
  context_projection_repaired:
    defineAgentTelemetryEvent<ContextProjectionRepairedEvent>({
      owner: "kimi-code",
      comment:
  ...
  background_task_created:
    defineAgentTelemetryEvent<BackgroundTaskCreatedEvent>({
      owner: "kimi-code",
  ...
  background_task_completed:
    defineAgentTelemetryEvent<BackgroundTaskCompletedEvent>({
      owner: "kimi-code",
  ...
  tool_call_dedup_detected:
    defineAgentTelemetryEvent<ToolCallDedupDetectedEvent>({
      owner: "kimi-code",
  ...
  agents_md_reminder_shown:
    defineAgentTelemetryEvent<AgentsMdReminderShownEvent>({
      owner: "kimi-code",
...
export type TelemetryEventPayload<K extends TelemetryEventName> =
  TelemetryEventRegistry[K] extends TelemetryEventDefinition<
    infer P,
