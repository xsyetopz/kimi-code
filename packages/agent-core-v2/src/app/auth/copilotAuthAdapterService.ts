...
export const ICopilotAuthAdapterRegistration: ServiceIdentifier<ICopilotAuthAdapterRegistration> =
  createDecorator<ICopilotAuthAdapterRegistration>('copilotAuthAdapterRegistration');

export class CopilotAuthAdapterRegistration extends Disposable implements ICopilotAuthAdapterRegistration {
