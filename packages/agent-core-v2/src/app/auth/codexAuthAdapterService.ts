...
export const ICodexAuthAdapterRegistration: ServiceIdentifier<ICodexAuthAdapterRegistration> =
  createDecorator<ICodexAuthAdapterRegistration>('codexAuthAdapterRegistration');

export class CodexAuthAdapterRegistration extends Disposable implements ICodexAuthAdapterRegistration {
