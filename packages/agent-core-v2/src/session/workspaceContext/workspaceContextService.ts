...
export const workspaceContextWorkDirKey = defineState<string>(
  "workspaceContext.workDir",
  () => "",
);
...
export class SessionWorkspaceContextService
  extends Disposable
  implements ISessionWorkspaceContext
{
