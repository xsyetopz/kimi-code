...
import type { OpaqueProviderState } from "#/kosong/contract/opaqueProviderState";

/**
 * Declarative compatibility profiles for transport, conversation/tool protocol,
 * and reasoning protocol. Pure metadata — adapters and the context projector
 * consult these flags; no I/O here.
 */
...
export type { OpaqueProviderState };
