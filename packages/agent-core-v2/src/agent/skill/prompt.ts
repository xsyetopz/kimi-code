...
export function renderUserSlashSkillPrompt(
  input: RenderSkillPromptInput,
): string {
  return [
...
export interface RenderModelToolSkillPromptInput
  extends RenderSkillPromptInput {
  readonly trigger: Extract<SkillPromptTrigger, "model-tool" | "nested-skill">;
}

export function renderModelToolSkillPrompt(
  input: RenderModelToolSkillPromptInput,
): string {
  return [
...
export function renderSkillLoadedBlock(
  input: RenderSkillLoadedBlockInput,
): string {
  return [
