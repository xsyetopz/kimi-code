...
export function logFieldsForSource(
...
export function requestKindForRecord(
...
export function projectionField(
  ...
  return value === "strict" ||
    value === "media-degraded" ||
    value === "media-stripped"
    ? value
    : undefined;
}
