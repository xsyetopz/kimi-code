...
export const toolDedupeStepCallsKey = defineState<string[]>(
  "toolDedupe.stepCalls",
  () => [],
);
...
export const toolDedupeActiveStepKey = defineState<number>(
  "toolDedupe.activeStep",
  () => 0,
);

export class AgentToolDedupeService
  extends Disposable
  implements IAgentToolDedupeService
{
