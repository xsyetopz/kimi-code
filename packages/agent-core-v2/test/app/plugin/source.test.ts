...
describe("resolveInstallSource", () => {
  ...
  it("resolves github tree, release tag, and commit urls", () => {
    expect(
      resolveInstallSource("https://github.com/owner/repo/tree/release%231"),
    ).toEqual({
      kind: "github",
      owner: "owner",
      repo: "repo",
    ...
    expect(
      resolveInstallSource("https://github.com/owner/repo/releases/tag/v1.2.3"),
    ).toEqual({
      kind: "github",
      owner: "owner",
      repo: "repo",
    ...
    expect(
      resolveInstallSource("https://github.com/owner/repo/commit/abc1234"),
    ).toEqual({
      kind: "github",
      owner: "owner",
      repo: "repo",
