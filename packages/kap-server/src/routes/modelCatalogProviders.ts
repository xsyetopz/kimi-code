...
import { handleImportCatalog, handleImportRegistry } from "./modelCatalogImport";
import {
  ...
  loadDiscovery,
  loadOAuth,
  providerActionTailParamSchema,
  providerCollectionActionParamSchema,
  providerIdParamSchema,
  seedDefaultModelWhenUnset,
  sendMappedError,
  type ModelCatalogRouteHost,
  type StatusReply,
} from "./modelCatalogShared";

export function registerModelCatalogProviderRoutes(
