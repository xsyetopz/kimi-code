...
export function RightPanel({
  ...
  return (
    <div className="flex h-full w-[440px] shrink-0 flex-col border-l border-neutral-800 bg-neutral-900/30">
      ...
      <div
        className={tab === "audit" ? "flex min-h-0 flex-1 flex-col" : "hidden"}
      >
        {trail !== null ? (
      ...
      <div
        className={tab === "agent" ? "flex min-h-0 flex-1 flex-col" : "hidden"}
      >
        <Inspector
          sessionId={sessionId}
          agentId={agentId}
      ...
      <div
        className={
          tab === "state" ? "min-h-0 flex-1 overflow-y-auto" : "hidden"
        }
      >
        <div className="p-3">
