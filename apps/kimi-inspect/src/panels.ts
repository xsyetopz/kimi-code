...
export const SESSION_PANELS: readonly ServicePanelDef[] = [
    ...
    actions: [
      {
        label: "Set title",
        input: "New title",
        run: (svc, title) => call(svc, "setTitle", title),
      },
      {
        label: "Archive",
        danger: true,
        run: (svc) => call(svc, "setArchived", true),
      },
  ...
  },
  {
    ...
    actions: [
      {
        label: "generateAgentsMd (/init)",
        run: (svc) => call(svc, "generateAgentsMd"),
      },
    ],
  },
];
    ...
    actions: [
      {
        label: "Set model",
        input: "Model id",
        run: (svc, model) => call(svc, "setModel", model),
      },
      {
        label: "Refresh system prompt",
        run: (svc) => call(svc, "refreshSystemPrompt"),
      },
    ],
  },
  {
