...
export class WelcomeComponent implements Component {
  ...
  render(width: number): string[] {
    ...
    const primary = (s: string): string =>
      chalk.hex(currentTheme.palette.primary)(s);
    ...
    if (safeWidth < 24) {
      const title = chalk.bold.hex(currentTheme.palette.primary)(
      ...
      const prompt = isLoggedOut
        ...
        : chalk.hex(currentTheme.palette.textDim)(
