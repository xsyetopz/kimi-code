...
export const WORKING_TIPS: readonly ToolbarTip[] = [
  {
    text: "ctrl-s to add guidance without waiting for the turn to finish",
    priority: 2,
    solo: true,
  },
  {
    text: "/tasks to check progress and status for background tasks",
    priority: 2,
  },
  ...
  {
    text: 'ask Kimi to schedule tasks, e.g. "remind me at 5pm"',
    solo: true,
    priority: 3,
  },
  { text: "/sessions to browse and resume earlier sessions", solo: true },
  {
    text: "/goal for multi-step work with a clear finish line",
    priority: 2,
    solo: true,
  },
  {
    text: "/goal next to queue follow-up work while the current goal keeps running",
    solo: true,
  },
...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  {
    text: "ctrl-o to hide or reveal tool output switching between a clean chat view and full execution details",
    priority: 2,
  },
  {
    text: "shift-tab to Plan mode to review the approach before Kimi edits files.",
    priority: 2,
  },
