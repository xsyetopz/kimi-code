/** Output rendering for the native `kimi -p` print runner. */

import type { PromptOutputFormat } from "./options";

/** Structural hook-result shape exposed by the native event bus. */
...
/** Structural retry shape exposed by the native event bus. */
