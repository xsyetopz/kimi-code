...
describe("pageView", () => {
  it("keeps the selected index on the first page", () => {
    expect(pageView(60, 3, 8)).toEqual({
      page: 0,
      pageCount: 8,
      start: 0,
      end: 8,
  ...
  it("derives the page containing the selected index", () => {
    ...
    expect(pageView(60, 12, 8)).toEqual({
      page: 1,
      pageCount: 8,
      start: 8,
      end: 16,
  ...
  it("clamps the final page slice to the total", () => {
    ...
    expect(pageView(60, 59, 8)).toEqual({
      page: 7,
      pageCount: 8,
      start: 56,
      end: 60,
  ...
  it("clamps a selectedIndex past the end onto the last page", () => {
    expect(pageView(10, 999, 4)).toEqual({
      page: 2,
      pageCount: 3,
      start: 8,
      end: 10,
  ...
  it("clamps a negative selectedIndex to the first page", () => {
    expect(pageView(10, -5, 4)).toEqual({
      page: 0,
      pageCount: 3,
      start: 0,
      end: 4,
