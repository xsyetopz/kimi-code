      ...
      >
        <div className="flex items-center justify-between gap-2">
          <div className="flex min-w-0 items-center gap-2">
            ...
            />
            <span className="shrink-0 font-mono text-[12px] text-fg-0">
              {shortId}
            </span>
            {session.imported ? (
              <span
        ...
        <div className="mt-1 flex items-center gap-3 font-mono text-[10.5px] text-fg-2">
          ...
          {session.imported && session.importMeta?.manifest?.kimiCodeVersion ? (
            <span
              className="tabular text-fg-3"
              title="kimi-code version that produced this bundle"
            >
        ...
        {title ? (
          <div
            className="mt-1 truncate font-mono text-[11px] text-fg-1"
            title={title}
          >
            {title}
          </div>
