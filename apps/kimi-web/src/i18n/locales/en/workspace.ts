export default {
  ...
  deleteHasSessions:
    "This workspace still has sessions — archive them before deleting it",
  ...
  goalStartConfirm:
    'Start goal: "{objective}"? The agent will run autonomously toward it.',
  ...
  browseHint:
    'Click a folder to enter it, then "Open this folder" to add it as a workspace.',
  ...
  pathFollowHint:
    'Folder located — press Enter or "Open this folder" to add it.',
  degradedPlaceholder: "Type an absolute path, press Enter to add…",
  degradedHint:
    "File browsing is unavailable — type an absolute path and press Enter to add.",
  // Attention marker
  attentionTitle:
