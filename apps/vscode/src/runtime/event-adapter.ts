...
export function adaptSdkEvent(
  ...
  if (sdkEvent.type === "subagent.spawned") {
    const parentAgentId =
      sdkEvent.parentAgentId ?? sdkEvent.callerAgentId ?? sdkEvent.agentId;
    return {
      state: {
        ...state,
        subagentParents: {
  ...
  switch (sdkEvent.type) {
    ...
    case "assistant.delta":
      return {
        ...
        event: {
          type: "ContentPart",
          payload: { type: "text", text: sdkEvent.delta },
        },
      };
    case "hook.result":
      return {
        ...
        event: {
          type: "ContentPart",
          payload: { type: "text", text: sdkEvent.content },
        },
      };
    case "thinking.delta":
      return {
        ...
        event: {
          type: "ContentPart",
          payload: { type: "think", think: sdkEvent.delta },
        },
      };
    case "tool.call.started": {
      ...
      const display =
        sdkEvent.display === undefined
          ? undefined
          : toLegacyDisplay(sdkEvent.display);
      return {
        state:
          display === undefined
            ? state
...
function mapStatusUpdate(
  ...
  if (sdkEvent.thinkingEffort !== undefined)
    payload.thinking_effort = sdkEvent.thinkingEffort;
